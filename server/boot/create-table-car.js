module.exports = function(app) {
  app.dataSources.rakLocalMysql.automigrate('Car', function(err) {
    ...
    app.models.Car.create([
      {name: 'Car1', userId:1},
      {name: 'Car2', userId:2},
      {name: 'Car3', oddEven:'odd', image:'img/car-1.jpg', totalSeats:5, seatsLeft:2, isSun:true, startHr:12, startMin:30, startAMPM:'AM', endHr:06, endMin:10, endAMPM:'PM', startPlace:'Haiderpur', endPlace:'Gurgaon', milage:24, distance:30, message:"Smoking and Drinking will be allowed and will be done", userId:4},
    ], function(err, Car) {
      if (err) throw err;
  ...
  app.dataSources.rakLocalMysql.automigrate('user', function(err) {
    ...
    app.models.user.create([
      ...
      {name: 'User3', password: 'sdsdsd', email: 'demo3@demo.com',carId:32},
    ], function(err, user) {
      if (err) throw err;
